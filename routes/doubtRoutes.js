...
import { createDoubtValidator, updateDoubtStatusValidator } from '../validators/doubtValidator.js';
...
router.get('/getDoubts', authenticate, getDoubts);
router.get('/getDoubtById/:id', authenticate, getDoubtById);
