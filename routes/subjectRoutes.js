...
import { createSubject, getSubjectsByDepartment, updateSubjectStatus } from '../controllers/subjectController.js';
...
router.patch("/updateSubject-status/:id", authenticate, authorizeAdminOrHod, updateSubjectStatus);
